    ...
    <div class="flex justify-center">
      <div class="w-full max-w-xs">
        <form class="bg-main-300 shadow-md rounded px-5 pt-5 pb-8 mb-4" >
          <div class="flex justify-between items-start rounded-t border-none bg-main-300">
            <svg class="ml-16 w-36 h-36" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 511 511" style="enable-background:new 0 0 511 511;" xml:space="preserve">
            ...
            <button @click="close()" type="button" class="text-tc-500 bg-alert-200 hover:bg-gray-200 hover:text-gray-900 rounded-full text-sm p-1.5 inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" >
