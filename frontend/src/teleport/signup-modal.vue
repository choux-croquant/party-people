    ...
    <div class="flex justify-center">
      ...
      <form class="bg-main-300 shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <div class="flex justify-between items-start rounded-t border-b bg-main-300">
            <button type="button" @click="close()" class="text-tc-500 bg-alert-200 hover:bg-gray-200 hover:text-gray-900 rounded-full text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white">
        ...
        <div class="flex items-center justify-center">
          <button class="bg-gradient-to-r from-main-100 to-sub-100 text-white font-bold h-10 py-1 px-24 rounded-full focus:outline-none focus:shadow-outline" type="button" @click="signup()">
            가입하기
          </button>
        </div>
      </form>
