<template>
  <div class="bottom flex justify-center mb-5">
    <div>
      <svg xmlns="http://www.w3.org/2000/svg" class="cursor-pointer py-2 px-2 mx-5 h-10 w-10 text-red-600 bg-main-200 rounded-full" fill="none" viewBox="0 0 24 24" stroke="currentColor">
