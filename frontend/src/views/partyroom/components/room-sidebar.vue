      ...
      >
        ...
        >
          ...
          <div class="hover:bg-sub-300 w-full cursor-pointer" v-show="showContentBtn" @click="clickContentBtn">
            ...
            >
              <svg version="1.1" class="sidebar-menu-icon h-8 w-8" id="contents-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          ...
          <div class="hover:bg-sub-300 w-full cursor-pointer" v-show="showRoomBtn">
            <a 
              class="h-24 px-6 flex flex-col justify-center items-center w-full"
            >
              <svg class="sidebar-menu-icon h-8 w-8" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          ...
          <div class="hover:bg-sub-300 w-full cursor-pointer" v-show="showLinkBtn" @click="clickLinkBtn">
            <a 
              class="h-24 px-6 flex flex-col justify-center items-center w-full"
            >
              <svg class="sidebar-menu-icon h-8 w-8" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
