  ...
  >
    ...
    >
      ...
      <div class="hover:bg-sub-300 w-full cursor-pointer" v-show="showContentBtn" @click="clickContentBtn">
        ...
        >
          <svg version="1.1" class="sidebar-menu-icon h-8 w-8" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      ...
      <div class="hover:bg-sub-300 w-full cursor-pointer" v-show="showTimerBtn" @click="clickTimer()">
        <a
          class="h-24 px-6 flex flex-col justify-center items-center w-full"
        >
          <svg class="sidebar-menu-icon h-7 w-7" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 296.228 296.228" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 296.228 296.228">
            <g>
      ...
      <div class="hover:bg-sub-300 w-full cursor-pointer" v-show="showVoteBtn" @click="clickVote()" @startVote="sendVote">
        <a
          class="h-24 px-6 flex flex-col justify-center items-center w-full"
        >
          <svg class="sidebar-menu-icon h-8 w-8" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
